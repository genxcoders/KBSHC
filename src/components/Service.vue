<template>
    <div>
        <HeaderBanner
            banner-title="SERVICES AT KBS HEALTH CARE"
            banner-text="We specialize in Medical Billing, Coding & Audits, Account Receivables, Denial Management, Claims Management, RCM Solutions, Credit Balance Resolution"
                ...
                <div class="row">
                    ...
                    <div class="col-12 pb-4">
                        <div class="service-box d-block pb-4">
                            ...
                            <p class="mb-0">
                                We help our clients to improve cash-flow and reduce days in A/R so that they get paid more, faster and at a much competative cost.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pb-4">
                        <div class="service-box d-block pb-4">
                            ...
                            <p>
                                KBS provides access to a large and scalable pool of resources experienced in multiple Practice Management Systems.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pb-4">
                        <div class="service-box d-block pb-4">
                            ...
                            <p class="mb-0">
                                KBS provides end-to-end, comprehensive Revenue Cycle Management solutions from payer credentialing to complete billing and collection services. With 5+ years of RCM experience, our billing experts are well versed in all Medicaid state plans, managed care plans, government-funded programs, third-party insurance, and Medicare billing rules. We follow industry-standards key performance metrics to measure success and integrate best practices, so that you get the value of our proven experience and expertise.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pb-4">
                        <div class="service-box d-block pb-4">
                            ...
                            <p>
                                This liability carries with it real and serious financial and compliance risk. It is your fiduciary responsibility to manage these real risks. Industry data shows that over 55% of credit balances are a result of incorrect posting of allowances.
                            </p>
                            <p>
                                Federal Register rules published and brought into effect in mid of March 2016 states:
                            </p>
                            <ul>
                                <li>
                            ...
                            <p>
                                KBS has built strong working relationships with our clients to consistently meet their needs as credit balance backlogs are prioritized and processed. Incorrect adjustments, erroneous credits, and misuse of debit codes makes this credit balance task quite challenging, requiring precision, attention to detail, and a focus on operational excellence.
                            </p>
                            <p>
                                KBS has maintained a team specialized in credit balances resolution since 2010. The team is comprised of highly-qualified individuals with a hospital accounting background and strong analytical skills. All KBS analysts are diligent and well trained to ensure outstanding credit balances are accurately resolved in an expeditious manner. We understand a professional and cooperative environment is the key to resolving more credit balances, many of which become ‘account corrections’ as opposed to actual ‘refunds’; hence, our operational model is highly client-centric.
                            </p>
